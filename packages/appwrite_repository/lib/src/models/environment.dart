...
class Environment {
  ...
  /// The ID of order collection.
  final String orderCollectionId;

  /// The ID of billing collection.
  final String invoiceCollectionId;
  ...
  /// The ID of categories collection.
